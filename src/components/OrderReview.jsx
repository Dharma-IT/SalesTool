                    ...
                    {entry.striveLink && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <button onClick={() => handleCopySheetLink(entry.striveLink, `${product.id}-strive`)} style={{ flexShrink: 0, background: '#e2e8f0', border: 'none', borderRadius: '8px', padding: '5px 10px', fontSize: '0.75rem', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}>
                          ...
                          {copiedLink === `${product.id}-strive` ? 'Copied' : 'Copy'}
                        </button>
                        <a href={entry.striveLink} target="_blank" rel="noreferrer" style={{ flexShrink: 0, background: 'rgba(212,175,55,0.12)', border: '1px solid rgba(212,175,55,0.3)', borderRadius: '8px', padding: '5px 10px', display: 'flex', alignItems: 'center', gap: '4px', textDecoration: 'none', color: 'var(--primary)', fontSize: '0.75rem', fontWeight: '700' }}>
